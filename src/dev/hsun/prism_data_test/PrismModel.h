...
/**
 * @file PrismModel.h
 * @brief Defines a 3-bar tensegrity model
 * @author 
 * $Id$
 */
...
private:
    ...
    /*
     * A function that adds markers to the end of the rods so that we can 
...
private:    
    ...
    /**
     * A pointer to tgObserver to log positions and tensions.
     */
    tgDataObserver* m_pObserver;
