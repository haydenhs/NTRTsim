 ...
 * @brief Implementation of a 2-bar planar tensegrity.
 * @author 
 * $Id$
 */
...
SimpleController::SimpleController(const double tension) :
    m_tension(tension)
{
    if (tension < 0.0)
    {
...
void SimpleController::onSetup(SimpleModel& subject)
{
...
void SimpleController::onStep(SimpleModel& subject, double dt)
{
	if (dt <= 0.0)
    {
